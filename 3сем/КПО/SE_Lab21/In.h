...
//таблица значений входной информации, индекса = код (Windows-1251) символа
//значения IN::F - запрещенный элемент, IN::T - разрешенный элемент, IN::I - игнорировать (не вводить),
...
namespace In
{
	struct IN //исходные файлы
	{
		...
		int size; //размер исходного файла
		int lines; //количесвто строчек
